...
import { LayoutDashboard, Mail, Lock, ArrowRight, Github, Chrome, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0f1117] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10 animate-in fade-in zoom-in duration-500">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-extrabold text-white tracking-tight">AI Social Intel</h1>
          <p className="text-slate-400 mt-2">The next generation of social intelligence.</p>
        </div>
        ...
        <div className="bg-[#1a1d2e]/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                ...
                <Link href="#" className="text-xs text-[#7c3aed] hover:underline">Forgot password?</Link>
              </div>
              <div className="relative">
            ...
            <button 
              type="submit"
              disabled={loading}
              className="w-full bg-[#7c3aed] hover:bg-[#6d28d9] text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg shadow-purple-500/20 group"
            >
              {loading ? (
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#1a1d2e] px-2 text-slate-500">Or continue with</span>
            </div>
          </div>
        ...
        <p className="text-center mt-8 text-slate-500 text-sm">
          Don't have an account? <Link href="/register" className="text-[#7c3aed] font-semibold hover:underline">Start for free</Link>
        </p>
      </div>
    </div>
  );
